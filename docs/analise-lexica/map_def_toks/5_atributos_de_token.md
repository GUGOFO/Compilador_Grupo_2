...
## 5.2 - Estrutura da Union (Exemplo)
...
| TOK_CHAR_LIT   | ival            | yylval.ival = yytext[1];      |
| TOK_ID         | sval            | yylval.sval = strdup(yytext); |
| TOK_STRING_LIT | sval            | yylval.sval = strdup(yytext); |

## 5.4 - Importância da Função strdup()
