...
# Planejamento do Analizador Sintatico

Este documento estabelece o roteiro técnico para a implementação do analisador sintatico. O objetivo é 

transformar o fluxo de caracteres do código-fonte C++ em uma sequência de unidades lógicas denominadas Tokens.
...
Iremos usar um arquivo .l para isso.
